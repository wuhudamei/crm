...
import com.rocoinfo.service.basicConfig.RemindRuleService;
 ...
 * 
 * @author Paul
 * @time 2017-06-07 18:39:33
 *
 */
@RestController
@RequestMapping(value = "/api/rule/remindRule")
public class RemindRuleRestController extends BaseController{
	
	@Autowired
	private RemindRuleService remindRuleService;
	...
	public Object list(@RequestParam(value = "name", required = false) String name,
		...
		PageTable page = remindRuleService.searchScrollPage(params, new Pagination(offset, limit));
	...
	public Object updateStatusById(Long id, String status){
		...
		boolean flag = remindRuleService.updateStatusById(id,status);
		if(flag){
